...
process.TFileService = cms.Service("TFileService", fileName = cms.string('L1TrkNtuple_HYBRID_NEWKF_TTbar_1000Events.root'), closeFileFast = cms.untracked.bool(True))
...
# HYBRID_NEWKF: prompt tracking or reduced
    ...
    if (L1TRKALGO == 'HYBRID_NEWKF' or L1TRKALGO == 'HYBRID_REDUCED'):
       NHELIXPAR = 4
