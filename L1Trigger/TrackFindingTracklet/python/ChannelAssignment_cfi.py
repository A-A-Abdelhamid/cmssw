...
ChannelAssignment_params = cms.PSet (
  ...
  TM = cms.PSet (
    ...
    MuxOrder    = cms.vstring( "L1L2", "L2L3", "L1D1", "D1D2", "D3D4", "L2D1", "L3L4", "L5L6" , "L3L4L2", "L5L6L4", "L2D1D2", "L2L3D1"),
  ...
  SeedTypesSeedLayers = cms.PSet (      # seeding layers of seed types using default layer id [barrel: 1-6, discs: 11-15]
    ...
    L3L4L2 = cms.vint32(  2,  3,  4 ),
    L5L6L4 = cms.vint32(  4,  5,  6 ),
    L2L3D1 = cms.vint32(  2,  3, 11 ),
    D1D2L2 = cms.vint32(  2, 11, 12 )
  ),
